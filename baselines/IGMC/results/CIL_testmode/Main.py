...
if args.standard_rating:
    ...
    elif args.data_name == 'CIL':  # original 1, 2, ..., 5
...
elif args.data_name == 'CIL':
    (
        u_features, v_features, adj_train, train_labels, train_u_indices, train_v_indices,
        val_labels, val_u_indices, val_v_indices, test_labels, test_u_indices,
        test_v_indices, class_values
    ) = create_CIL_trainvaltest_split(args.testing, True, rating_map, post_rating_map, args.ratio, 0, 0
    )
else:
    (
        u_features, v_features, adj_train, train_labels, train_u_indices, train_v_indices,
