"""
Appends HOFM features to LibFM BayesianSVD++ train, valid and submission files
"""

train90_file = "/baselines/DeepRec/data/train90/CIL_data90.train"
train90hofm_file = "/baselines/BayesianSVD/data_features/HOFM_features/HOFMtrain90.csv"
train90aug_file = "data_features/HOFM_features/CIL_data90aug.train.libfm"
train100_file = "/baselines/DeepRec/data/train100/CIL_data100.train"
train100hofm_file = "/baselines/BayesianSVD/data_features/HOFM_features/HOFMtrain100.csv"
train100aug_file = "data_features/HOFM_features/CIL_data100aug.train.libfm"
valid_file = "/baselines/DeepRec/data/valid/CIL_data10.valid"
validhofm_file = "/baselines/BayesianSVD/data_features/HOFM_features/HOFMval10.csv"
validaug_file = "data_features/HOFM_features/CIL_dataaug.valid.libfm"
sub_file = "/baselines/DeepRec/data/submission/CIL_data.submission"
subhofm_file = "/baselines/BayesianSVD/data_features/HOFM_features/HOFMsub.csv"
subaug_file = "data_features/HOFM_features/CIL_dataaug.submission.libfm"
