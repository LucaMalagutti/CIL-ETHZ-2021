...
int main(int argc, char **argv) {
  ...
  try {
    ...
    const std::string param_T_init = cmdline.registerParameter("T_init", "initial temperature for the Simulated Annealing in MCMC; default=10");
    ...
    // Set default params for Simulated Annealing
