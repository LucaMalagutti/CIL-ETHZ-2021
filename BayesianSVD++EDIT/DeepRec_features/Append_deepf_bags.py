"""
Generates train, validation, submission files for LibFM containing implicit
user and item information (Bayesian SVD++) and deep features from DeepRec
"""
...
train90aug_file = "data_features/CIL_data90aug.train.libfm"
train100_file = "../../baselines/DeepRec/data/train100/CIL_data100.train"
train100aug_file = "data_features/CIL_data100aug.train.libfm"
valid_file = "../../baselines/DeepRec/data/valid/CIL_data10.valid"
validaug_file = "data_features/CIL_dataaug.valid.libfm"
sub_file = "../../baselines/DeepRec/data/submission/CIL_data.submission"
subaug_file = "data_features/CIL_dataaug.submission.libfm"
deepf_json = "deepfeatures90_2ndBottleneck.json"
deepf90_json = "deepfeatures100_2ndBottleneck.json"
